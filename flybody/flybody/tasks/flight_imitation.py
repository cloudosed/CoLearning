...
class FlightImitation(Flying):
    ...
    def get_reward_factors(self, physics):
        ...
        # # calculate the body pitch angle
        # roll_angle = self._walker.observables.gyro(physics)[2]
        # # print(f'Body roll angle: {roll_angle} degrees')
        # roll_angle = (180 - abs(roll_angle)) / 180
        # roll_score = rewards.tolerance(roll_angle,
        #                                 bounds=(0.8, 1),
        #                                 sigmoid='linear',
        #                                 margin=0,
        #                                 value_at_margin=0.0)
...
class FlightImitationWBPG_Control(Flying):
